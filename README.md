...
FOR PULSE AT 250
![image](https://github.com/user-attachments/assets/309c00bc-e707-4e51-9811-af96f792a2c6)
```
TON = 1.5 * 10 * 10^-6
    = 0.000015
TOFF= 4.5 * 10 * 10^-6
...
FOR PULSE AT 500
![image](https://github.com/user-attachments/assets/a6c8b4f7-9b6e-4b10-9662-9d9aca51a612)
```
TON = 3 * 10 * 10^-6
    = 0.00003
TOFF= 3 * 10 * 10^-6
...
FOR PULSE AT 700
![image](https://github.com/user-attachments/assets/0d6680f7-b42e-4351-a114-05f36dcf79f7)
```
TON = 4.5 * 10 * 10^-6
    = 0.000045
TOFF= 1.5 * 10 * 10^-6
